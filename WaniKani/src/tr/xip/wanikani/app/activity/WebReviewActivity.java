...
import tr.xip.wanikani.userscripts.EnhanceMobileCSS;
...
public class WebReviewActivity extends AppCompatActivity {
     ...
     * javascript thread, which is not necessarily a UI thread.
...
*/
    ...
    private void enhanceMobileCSS ()
    {
      if(PrefManager.getMobileCSS())
      {
        ...
        ignbtn.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 24);
      }
    }
}
